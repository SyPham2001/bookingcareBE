...
import handbookController from "../controllers/handlebookController";
...
let initWebRoutes = (app) => {
  ...
  router.post(
    "/api/patient-book-appoitment",
    patientController.postBookAppoitment
  );
  router.post(
    "/api/verify-book-appoitment",
    patientController.postVerifyBookAppoitment
  );
  // specialty
